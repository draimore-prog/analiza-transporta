...
export function exportMasterFleetToExcel(fleet: Vehicle[], filename = "Sifrarnik_Voznog_Parka_2026.xlsx") {
...
export function exportTransactionsToExcel(data: CostItem[], filename = "Tabela_Servisa_Transakcije.xlsx") {
