          ...
          {supplierStats.map(([supName, stats], idx) => {
            ...
            return (
              <div
                ...
                className="card bg-slate-50 dark:bg-slate-900/60 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xs cursor-pointer hover:border-blue-500 hover:shadow-md transition-all group"
              >
