...
import { calculateFleetByYear, calculateDynamic2026, formatKM } from "@/lib/calculations";
...
export function TransportKpis({
  ...
  // Cost by year calculation
  const yearlyStats = useMemo(() => {
    const years = [2021, 2022, 2023, 2024, 2025, 2026];
    const stats: Record<number, { cost: number; count: number }> = {};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Card 4: Average per Vehicle 2026 */}
