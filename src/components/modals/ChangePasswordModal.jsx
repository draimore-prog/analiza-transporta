...
export function ChangePasswordModal({
  ...
  return (
    <div onClick={onClose} className="fixed inset-0 bg-slate-900/75 flex justify-center items-center z-[80] backdrop-blur-xs p-4 cursor-pointer">
      <div onClick={(e) => e.stopPropagation()} className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden border border-slate-100 dark:border-slate-800 p-6 animate-in fade-in zoom-in-95 duration-200 cursor-default">
