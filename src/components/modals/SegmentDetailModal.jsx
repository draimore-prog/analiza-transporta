  ...
  return (
    <div onClick={onClose} className="fixed inset-0 bg-slate-900/80 flex justify-center items-center z-[75] backdrop-blur-xs p-3 sm:p-5 animate-in fade-in zoom-in-95 duration-200 cursor-pointer">
      <div onClick={(e) => e.stopPropagation()} className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-5xl h-[92vh] max-h-[92vh] flex flex-col overflow-hidden border border-slate-200 dark:border-slate-800 cursor-default">
        {/* Header */}
        <div className="flex justify-between items-center p-4 sm:p-5 bg-gradient-to-r from-slate-900 via-emerald-950 to-teal-950 text-white shrink-0">
        ...
        <div className="p-4 sm:p-5 flex flex-col flex-1 min-h-0 overflow-hidden space-y-3 bg-slate-50 dark:bg-slate-900/50 text-xs">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 shrink-0">
            <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
              <p className="text-[9px] uppercase font-bold text-slate-400">Ukupan Trošak Segmenta</p>
              <h3 className="text-lg font-black text-emerald-600 dark:text-emerald-400 mt-0.5">
                {formatKM(totalCost)}
              </h3>
              <p className="text-[9px] text-slate-500">
                {segmentShare}% ukupnih troškova
              </p>
            </div>

            <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
              <p className="text-[9px] uppercase font-bold text-slate-400">Broj Intervencija</p>
              <h3 className="text-lg font-black text-slate-900 dark:text-white mt-0.5">
                {segmentTransactions.length.toLocaleString("bs-BA")}
              </h3>
              <p className="text-[9px] text-slate-500">
                Realizovanih popravki
              </p>
            </div>

            <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
              <p className="text-[9px] uppercase font-bold text-slate-400">Prosjek po Intervenciji</p>
              <h3 className="text-lg font-black text-slate-900 dark:text-white mt-0.5">
            ...
            <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
              <p className="text-[9px] uppercase font-bold text-slate-400">Broj Vozila sa Popravkom</p>
              <h3 className="text-lg font-black text-slate-900 dark:text-white mt-0.5">
          ...
          {/* Godišnja Dinamika + Dobavljači Bedževi (Kompaktno) */}
            ...
            {distinctSuppliers.length > 0 && (
              <div className="flex flex-wrap items-center gap-1.5 pt-1.5 border-t border-slate-100 dark:border-slate-700/50">
                <span className="text-[10px] font-extrabold uppercase text-slate-500 flex items-center gap-1 mr-1">
                  <Building2 className="w-3 h-3 text-emerald-500" /> Serviser:
                </span>
                <button
                ...
                >
                  Svi ({segmentTransactions.length})
                </button>
                {distinctSuppliers.map((sup) => (
                  ...
                  >
                    <span>{sup.name}</span>
                    <span className="opacity-75 font-mono">({formatKM(sup.cost)})</span>
                  </button>
                ))}
              </div>
            )}
            ...
            <div className="p-2.5 bg-slate-100 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 flex flex-wrap justify-between items-center gap-2 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-extrabold text-slate-900 dark:text-white text-xs">
                  Spisak Računa ({filteredData.length.toLocaleString("bs-BA")} / {segmentTransactions.length.toLocaleString("bs-BA")})
                </h4>
                {isAnyFilterActive && (
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-2.5 py-0.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg font-bold text-[11px] flex items-center gap-1 shadow-xs transition-colors cursor-pointer"
                >
